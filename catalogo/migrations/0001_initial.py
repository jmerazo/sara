# Generated by Django 4.1.1 on 2023-09-21 01:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Users',
            fields=[
                ('id', models.CharField(db_column='UserID', max_length=50, primary_key=True, serialize=False)),
                ('email', models.CharField(blank=True, db_column='UserEmail', max_length=50, null=True)),
                ('password', models.CharField(blank=True, max_length=150, null=True)),
                ('fullname', models.CharField(blank=True, db_column='UserName', max_length=100, null=True)),
                ('rol', models.CharField(blank=True, db_column='UserRol', max_length=100, null=True)),
                ('active', models.CharField(blank=True, db_column='UserActive', max_length=30, null=True)),
