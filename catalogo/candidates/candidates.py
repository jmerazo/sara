...
class GeoCandidateTreesView(APIView):
    def get(self, request, format=None): 
        ...
        sql_query = """
            SELECT ea.cod_especie, ea.numero_placa, ef.nom_comunes, ef.nombre_cientifico, ea.departamento, ea.municipio, ea.vereda, ea.nombre_del_predio, ea.abcisa_xy, ea.resultado, ef.taxon_key, ef.habitos 
        ...
        for datos in results:
            cod_especie, numero_placa, nom_comunes, nombre_cientifico, departamento, municipio, vereda, nombre_del_predio, abcisa_xy, resultado, taxon_key, habitos = datos
