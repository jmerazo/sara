...
class CandidatesTrees(models.Model):
    ...
    datasetNumber = models.CharField(max_length=50, blank=True, null=True)
    ...
    organismRemarks = models.TextField()
    ...
    verbatimLatitude = models.CharField(max_length=1, blank=True, null=True)
    ...
    verbatimLongitude = models.CharField(max_length=1, blank=True, null=True)
